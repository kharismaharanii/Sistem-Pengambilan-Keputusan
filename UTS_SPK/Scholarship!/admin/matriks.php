                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Matriks C1</th>
                                    <th scope="col">Matriks C2</th>
                                    <th scope="col">Matriks C3</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                $no = 1;
                                $data = $koneksi->query("SELECT * from pendaftaran");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $hasilc2 = $tampil['penghasilan'] / $MinC2;
                                            echo $hasilc2;
                                            ?>
                                        </td>
                                        <td>
